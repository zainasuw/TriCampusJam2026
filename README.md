...
## Game Jam Team (Active Participants)
3 members participating in the Tri-Campus Game Jam: 
* **Zainab Stanikzy** (Programmer, Designer)
* **Pham (Yeni) Nguyen** (Programmer)
* **Salima Hafurova** (Programmer)

---
##  Credits and Assets
### Game Engine
This project is built using a custom game engine. While they appear in the GitHub contributor list (with their consent) due to the repository being a fork of the base engine code , they are **not** active participants in this game jam: 
* **Chris Marriott** (@algorithm0r) - Professor / Engine Author
* **KV Le** (@kvietcong) - TA / Engine Contributor
...
**(https://la-petite-baleine.github.io/TriCampusJam2026/)**
